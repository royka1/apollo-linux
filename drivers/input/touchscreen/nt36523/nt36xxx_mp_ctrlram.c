...
#ifndef NVT_SAVE_TESTDATA_IN_FILE
static void dump_buff(int32_t *rawdata, uint8_t x_ch, uint8_t y_ch)
{
	int32_t y = 0;
...
static int32_t parse_mp_setting_criteria_item(char **ptr, const char *item_string, int32_t *item_value)
{
	char *tmp = NULL;
...
static int32_t parse_mp_setting_ain_array(char **ptr, const char *item_string, uint8_t *ain_array, uint32_t IC_CFG_SIZE)
{
	char *tmp = NULL;
	int32_t i = 0;
	char *token = NULL;
...
static int32_t parse_mp_criteria_item_array(char **ptr, const char *item_string, int32_t *item_array)
{
	char *tmp = NULL;
	int32_t i = 0;
	int32_t j = 0;
...
/* kernel 5.6+: proc_create() requires proc_ops, not file_operations */
